    ...
    >
      ...
      >
        ...
        <div className="md:hidden flex flex-col items-center text-center w-full max-w-full mx-auto">
          ...
          <h1 className="text-5xl font-bold text-sand mb-8 -mt-12" style={{ fontFamily: 'var(--font-polya)', fontWeight: 'bold' }}>
            Maxime Farineau
          </h1>
        ...
        <div className="hidden md:block">
          <div className="bg-ocean-deep/60 backdrop-blur-xl rounded-2xl p-8 border border-accent-blue/20 shadow-2xl">
            {/* Nom */}
            <div className="mb-3">
              <h1 className="text-4xl lg:text-5xl font-bold text-sand" style={{ fontFamily: 'var(--font-polya)', fontWeight: 'bold' }}>
                Maxime Farineau
              </h1>
            </div>
